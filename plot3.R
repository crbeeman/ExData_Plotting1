...
with(data3, plot(V1,V7, type="n", xlab = "", ylab = "Energy Sub Metering"))
with(data3, points(V1,V7, col="black", type="l"))
with(data3, points(V1,V8, col="red", type="l"))
with(data3, points(V1,V9, col="blue", type="l"))
